...
"Outline Template - Download and Use This Format"

![Outline Template in Blackboard](markdown/outline_template.png "Outline Template")
...
Typed Outline - Submit under this Week's Folder

![Outline Assignment](markdown/outline_assignment.png "Outline Assignment")

--

## Speech 3 Outline

- Include your sources here in APA 7 format - References Section in Outline
- Do not use this when giving your speech - only for preparation/organization
- Optional (recommended) - create a speaker's outline to use during your speech.
    - Brief phrases
    - Key words
    - Key ideas
    - Like instructions to get you through your speech
